...
#'internal package functions: [scari::predict_xy_suitability()] or
#'[scari::predict_xy_suitability_CV()]. See details for specifics of formatting.
#'
...
#'[scari::compute_MaxEnt_summary_statistics()], with a filename ending in
#'"_summary.csv", or
#'[scari::compute_MaxEnt_summary_statistics_CV()], with a filename ending in
