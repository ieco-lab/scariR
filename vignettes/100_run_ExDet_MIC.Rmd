---
title: "Run an ExDet (NT2) analysis and calculate MIC"
...
I will pull the rasters from the above functions and will save them to my working directory. Then, I will create plots of each raster and save those as well.
...
Next, I will save the output rasters. The MIC raster needs an extra step of converting the names of the values from a number scale to the name of the variable. I will use a separate data frame to classify those variables.
...
mic_regional_native_hist_plot <- ggplot() +
  ...
  # default plot style
  map_style_MIC +
  viridis::scale_fill_viridis(option = "turbo", discrete = TRUE, labels = c("analogous", "bio11", "bio12", "bio15", "bio2"))
