...
This next helper function will make mapping of our exdet results more consistent, as the scale turned out to be rather complex. This function includes the above helper.
...
First, I will load the background points dataset used to train the model and that will be used to train the ExDet analysis. I have extracted the climate dataset from 1981-2010 for these points, but not for our projected time period. I will extract the values for the background points from each model from each SSP scenario.
