...
x_China_env_covariates_list <- list.files(path = file.path(mypath, "v1_maxent_10km"), pattern = "\\.asc$", full.names = TRUE) %>%
...
a_regional_background_points <- read.csv(file.path(here(), "vignette-outputs", "data-tables", "regional_native_background_points_v0.csv"))
...
slfSpread::compute_MaxEnt_summary_statistics(
  ...
  env.covar.obj = x_China_env_covariates, # env covariates raster stacked
