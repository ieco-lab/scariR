...
wineries_tidied_suit <- IVR_locations %>%
  ...
  left_join(xy_global_2055, join_by(ID, x, y)) %>%
  left_join(xy_regional_ensemble_2055, join_by(ID, x, y)) 
...
wineries_tidied_suit <- wineries_tidied_suit %>%
  ...
  dplyr::select(-c(xy_global_1995_rescaled, xy_regional_ensemble_1995_rescaled, xy_global_2055_rescaled, xy_regional_ensemble_2055_rescaled, risk_shift))
