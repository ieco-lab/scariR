...
(xy_joined_rescaled_plot <- ggplot(data = xy_joined_rescaled) +
 ...
 #  ) +
   ...
   # aesthetics
   scale_shape_manual(name = "Time period", values = c(21, 16)) +
   scale_color_manual(name = "Time period", values = c("black", "gray27")) +
...
(xy_joined_rescaled_plot <- ggplot() +
   ...
   geom_point(
     ...
     aes(x = xy_global_1995_rescaled, y = xy_regional_ensemble_1995_rescaled, fill = "Present"), 
     size = 1.5, shape = 21, stroke = 0.3
     ) +
   # GFDL ssp370 data
   geom_point(
   ...
   geom_segment(
     ...
     arrow = grid::arrow(angle = 25, type = "closed"), linewidth = 1, color = "darkred"
   ) +
   ...
   geom_segment(
     ...
     arrow = grid::arrow(angle = 25, type = "closed"), linewidth = 1, color = "darkorange"
   ) +
   ...
   geom_segment(
     ...
     arrow = grid::arrow(angle = 25, type = "closed"), linewidth = 1, color = "gold"
   ) +
   ...
   geom_segment(
     ...
     arrow = grid::arrow(angle = 25, type = "closed"), linewidth = 1, color = "azure4"
   ) +
   # axes scaling
   scale_x_continuous(name = "'global' model risk projection", limits = c(0, 1), breaks = breaks, labels = labels) + 
   scale_y_continuous(name = "'regional_ensemble' model risk projection", limits = c(0, 1), breaks = breaks, labels = labels) +
   ...
   geom_label(aes(x = 0.3, y = 0, hjust = "left", vjust = "bottom", label = "low risk"), fill = "azure4", color = "azure", size = 5) +
   # aesthetics
   scale_fill_manual(name = "Time period", values = c("purple3", "plum1")) +
   guides(fill = guide_legend(nrow = 1, override.aes = list(size = 2.5), reverse = TRUE)) +
   theme_bw() +
   theme(legend.position = "bottom", panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
   coord_fixed(ratio = 1)
)
