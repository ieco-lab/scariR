...
write_csv(quad_counts, file = file.path(mypath, "models", "working_dir", "ensemble_threshold_values.csv"))
...
IVR_risk_table <- IVR_locations_risk %>%
  ...
  rename("risk_1995 ~ risk_2055" = "risk_1995") %>%
  relocate("risk_1995 ~ risk_2055", "extreme", "high", "moderate")
