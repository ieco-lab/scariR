...
```{r create CMIP6 mic plot- ssp mean}
...
Now that we have created an ensembled prediction for our regional-scale models, we can compare them with the global model predictions and explore the suitability for SLF under climate change using suitability maps, point-wise predictions, quadrant plots, variable reponse curves and others.
