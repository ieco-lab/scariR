...
```{r display table, eval = TRUE, include = FALSE}
...
```{r create hist exdet plot, eval = TRUE, warning = FALSE}
...
```{r create CMIP6 exdet plot- ssp 126, eval = TRUE, echo = FALSE, warning = FALSE}
...
```{r save plot- exdet ssp126, warning = FALSE, include = FALSE}
...
```{r create CMIP6 exdet plot- ssp 370, eval = TRUE, echo = FALSE, warning = FALSE}
...
```{r save plot- exdet ssp370, warning = FALSE, include = FALSE}
...
```{r create CMIP6 exdet plot- ssp 585, eval = TRUE, echo = FALSE, warning = FALSE}
...
```{r save plot- exdet ssp585, warning = FALSE, include = FALSE}
...
```{r create CMIP6 exdet plot- ssp mean, eval = TRUE, echo = FALSE, warning = FALSE}
...
```{r save plot- exdet ssp mean, warning = FALSE, include = FALSE}
...
```{r create MIC plot- hist, eval = TRUE, echo = FALSE, warning=FALSE}
...
```{r save plot- mic hist, warning = FALSE, include = FALSE}
...
```{r create CMIP6 mic plot- ssp mean, eval = TRUE, echo = FALSE, warning = FALSE}
...
```{r save plot- mic ssp mean, warning = FALSE, include = FALSE}
...
```{r plot proportions, eval = TRUE, echo = FALSE, warning = FALSE}
...
```{r save plot- relative weights, warning = FALSE, include = FALSE}
