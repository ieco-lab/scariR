...
author: 
    - "Samuel M. Owens^[Temple University, [Center for Biodiversity](http://www.biodiversitycenter.org/), sam.owens@temple.edu]"
date: "2024-08-09"
---
...
```{r create CMIP6 exdet plot- ssp 126, eval = TRUE, echo = FALSE}
...
```{r create CMIP6 exdet plot- ssp 370, eval = TRUE, echo = FALSE}
...
```{r create CMIP6 exdet plot- ssp 585, eval = TRUE, echo = FALSE}
...
```{r create CMIP6 exdet plot- ssp mean, eval = TRUE, echo = FALSE}
...
```{r create CMIP6 mic plot- ssp mean, eval = TRUE, echo = FALSE}
...
```{r plot proportions, eval = TRUE, echo = FALSE}
