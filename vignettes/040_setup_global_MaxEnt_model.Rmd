...
# save as csv
write_csv(x = global_points, file = file.path(here::here(), "vignette-outputs", "data-tables", "global_background_points_v2.csv"))
# save as rds file
write_rds(global_points, file = file.path(here::here(), "data", "global_background_points_v2.rds"))
...
global_points <- read_csv(file = file.path(here::here(), "vignette-outputs", "data-tables", "global_background_points_v2.csv"))
...
global_patchwork <- (global_slf_plot / global_background_plot) +
  ...
  plot_annotation(title = "'global' model elements") 

# work around because collect axes not working
global_patchwork <- patchwork::patchworkGrob(global_patchwork) %>%
