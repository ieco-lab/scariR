...
ggsave(
  ...
  filename = file.path(here::here(), "vignette-outputs", "figures", "global_model_background_points_v3.jpg"),
  height = 8, 
  width = 12,
  device = "jpeg",
  dpi = "retina"
...
ggsave(
  global_slf_plot, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "global_model_presence_points_v3.jpg"),
  height = 8, 
  width = 12,
  device = "jpeg",
  dpi = "retina"
...
global_patchwork <- (global_slf_plot / global_background_plot) +
  ...
  plot_annotation(title = "global-scale model presences (A) and background points (B)") 
...
ggsave(
  global_patchwork, 
  filename = file.path(here::here(), "vignette-outputs", "figures", "global_model_v3_summary.jpg"),
  height = 8, 
  width = 10,
  device = "jpeg",
  dpi = "retina"
