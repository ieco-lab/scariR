...
model_info_kable <- kableExtra::kbl(x = model_info) %>%
...
if(FALSE) {
 ...
 # webshot::install_phantomjs()
  ...
  webshot::webshot(
    ...
    file = file.path(here::here(), "vignette-outputs", "figures", "global_model_info.pdf")
  )
...
ggsave(global_points_plot, 
       filename = file.path(here(), "vignette-outputs", "figures", "global_model_background_points.jpg"),
       height = 8, 
       width = 10,
       device = "jpeg",
       dpi = "retina")
...
ggsave(
  global_slf_plot, 
  filename = file.path(here(), "vignette-outputs", "figures", "global_model_presence_points.jpg"),
  height = 8, 
  width = 10,
  device = "jpeg",
  dpi = "retina"
