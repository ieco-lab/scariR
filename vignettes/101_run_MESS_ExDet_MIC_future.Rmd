---
title: "Run a MESS analysis and map covariate differences"
...
In this vignette, I will run a MESS analysis for each model and calculate a covariate difference metric. I will specifically use the background points that were used to train the model to perform the MESS. By doing this, I am effectively testing whether the covariates in other locations are significantly different from those used to train the model.
