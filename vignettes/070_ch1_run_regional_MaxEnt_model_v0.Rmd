---
title: "Run regional MaxEnt model (chapter 1)"
...
a_global_background_points <- read.csv(file.path(here(), "vignette-outputs", "data-tables", "global_background_points_v2.csv"))
...
SDMtune::swd2csv(swd = global_SWD, file_name = c(
  file.path(here(), "vignette-outputs", "data-tables", "global_slf_presences_with_data_v2.csv"),
  file.path(here(), "vignette-outputs", "data-tables", "global_background_points_with_data_v2.csv")
  ))
