...
slfSpread::create_MaxEnt_suitability_maps(
  ...
  projected = "NAmerica_1981-2010", # name of area or time period projected to
  predict.fun = "mean",
...
slfSpread::create_MaxEnt_suitability_maps(
  ...
  projected = "NAmerica_2041-2070_GFDL_ssp370", # name of area or time period projected to
  predict.fun = "mean",
  map.thresh = TRUE, # whether thresholded versions of these maps should be created
  thresh = c("MTP", "10_percentile", "MTSS"),
  summary.file = file.path(mypath, "global_summary_all_iterations.csv")
...
slfSpread::predict_xy_suitability(
  ...
  env.covar.obj = x_global_env_covariates,
  model.obj = global_model,
  mypath = mypath,
