...
ggsave(
  ...
  filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_01scale.jpg"),
  height = 8, 
  width = 10,
  device = "jpeg",
  dpi = "retina"
...
if (FALSE) {
  ...
  ggsave(
    ...
    filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_y_scaled.jpg"),
    height = 8, 
    width = 10,
    device = "jpeg",
    dpi = "retina"
...
if (FALSE) {
  ...
  ggsave(
    ...
    filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_x_scaled.jpg"),
    height = 8, 
    width = 10,
    device = "jpeg",
    dpi = "retina"
...
(slf_native_global_MTSS_plot_combined <- slf_native_global_MTSS_plot_x_edited +
    ...
    plot_annotation(
      title = "Suitability for SLF establishment at locations with known SLF populations",
      subtitle = "'global' vs 'regional_native' models | 1981-2010",
      caption = "thresholds: dashed = MTSS, twodash = 10_percentile, dotted = MTP"
      ) 
)
...
ggsave(
  ...
  filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_xy_scaled.jpg"),
  height = 8, 
  width = 12,
  device = "jpeg",
  dpi = "retina"
...
if (FALSE) {
  ...
  ggsave(
    ...
    filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_byCountry_x_scaled.jpg"),
    height = 8, 
    width = 10,
    device = "jpeg",
    dpi = "retina"
...
(slf_native_global_countries_plot_y <- ggplot() +
   ...
   labs(title ="Suitability for SLF establishment at locations with known SLF populations",
         subtitle = "'global' vs 'regional_native' models | 1981-2010",
         caption = "thresholds: twodash = 10_percentile, dashed = MTSS, dotted = MTP"
         ) +
   # scaling for axes
   scale_y_cut(breaks = as.numeric(summary_regional_native[42, 2] * 2), which = 1, scales = 0.25, space = 0.25) +
   ylab("'regional_native' model suitability") +
...
if (FALSE) {
  ...
  ggsave(
    ...
    filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_byCountry_y_scaled.jpg"),
    height = 8, 
    width = 10,
    device = "jpeg",
    dpi = "retina"
...
ggsave(
  ...
  filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_byCountry_xy_scaled.jpg"),
  height = 8, 
  width = 12,
  device = "jpeg",
  dpi = "retina"
...
if (FALSE) {
  ...
  ggsave(
    ...
    filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_ranges_x_scaled.jpg"),
    height = 8, 
    width = 10,
    device = "jpeg",
    dpi = "retina"
...
if(FALSE) {
  ...
  ggsave(
    ...
    filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_ranges_y_scaled.jpg"),
    height = 8, 
    width = 10,
    device = "jpeg",
    dpi = "retina"
...
ggsave(
  ...
  filename = file.path(here(), "vignette-outputs", "figures", "xy_suitability_slf_1981-2010_global_native_regional_MTSS_ranges_xy_scaled.jpg"),
  height = 8, 
  width = 12,
  device = "jpeg",
  dpi = "retina"
