...
readr::write_rds(united_states_slf_risk_report, file = file.path(here::here(), "vignette-outputs", "reports", "USA", "united_states_slf_risk_report.rds"))
...
slfSpread::create_risk_report(
  ...
  locality.type = "country",
  mypath = file.path(here::here(), "vignette-outputs", "reports", "south_korea"),
  create.dir = FALSE,
  save.report = TRUE
)
...
readr::write_rds(south_korea_slf_risk_report, file = file.path(here::here(), "vignette-outputs", "reports", "south_korea", "south_korea_slf_risk_report.rds"))
