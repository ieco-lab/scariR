...
a_regional_invaded_background_points <- read.csv(file.path(here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_unweighted.csv"))
...
SDMtune::swd2csv(swd = regional_invaded_train, file_name = c(
  file.path(here(), "vignette-outputs", "data-tables", "regional_invaded_train_slf_presences_with_data_v5.csv"),
  file.path(here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_with_data_v5.csv")
  ))
...
SDMtune::swd2csv(swd = regional_invaded_test, file_name = c(
  file.path(here(), "vignette-outputs", "data-tables", "regional_invaded_test_slf_presences_with_data_v5.csv")
  ))
