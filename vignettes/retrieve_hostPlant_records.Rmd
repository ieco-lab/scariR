...
# save
write_csv(toh_gbif_coords3, file = file.path(here(), "vignette-outputs", "data-tables", "toh_gbif_cleaned_coords_v1.csv"))

# also save as .rda file
save(toh_gbif_coords3, file = file.path(here(), "data", "toh_gbif_cleaned_coords_v1.rda"))
...
toh_gbif_coords4 <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "toh_gbif_cleaned_coords_v1.csv"))
...
# save
write_csv(toh_gbif_coords6, file = file.path(here(), "vignette-outputs", "data-tables", "toh_gbif_final_coords_v1.csv"))

# also save as .rda file
save(toh_gbif_coords6, file = file.path(here(), "data", "toh_gbif_final_coords_v1.rda"))
...
# thinned data
toh_thinned <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "toh_gbif_final_coords_v1.csv"))
...
# save
write_csv(vitis_gbif_coords2, file = file.path(here(), "vignette-outputs", "data-tables", "vitis_gbif_cleaned_coords_v1.csv"))

# also save as .rda file
save(vitis_gbif_coords2, file = file.path(here(), "data", "vitis_gbif_cleaned_coords_v1.rda"))
...
vitis_gbif_coords4 <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "vitis_gbif_cleaned_coords_v1.csv"))
...
# save
write_csv(vitis_gbif_coords6, file = file.path(here(), "vignette-outputs", "data-tables", "vitis_gbif_final_coords_v1.csv"))

# also save as .rda file
save(vitis_gbif_coords6, file = file.path(here(), "data", "vitis_gbif_final_coords_v1.rda"))
...
# thinned data
vitis_thinned <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "vitis_gbif_final_coords_v1.csv"))
...
if(FALSE) {
  ...
  # new data
  toh_new <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "toh_gbif_final_coords_v1.csv"))
