...
This vignette trains the last regional-scale model, the Rn model, which is based on the native range of SLF in east Asia. 
...
if (FALSE) {
  ...
  # also write to file
  readr::write_rds(x = regional_native_test, file = file.path(mypath, "regional_native_test.rds"))
