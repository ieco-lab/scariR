...
*NOTE* the output created from this point to the end of the vignette can be created using the function `scarifSDM::compute_MaxEnt_summary_statistics()`. This does not include the ending appendix or the chunks that create an output using `SDMtune::predict()`.
