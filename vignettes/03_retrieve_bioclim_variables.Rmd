...
# write tidied data
write.csv(x = env.cor4, file = file.path(here(), "data", "env_cor_chelsa_downsampled_abs.csv"), col.names = TRUE, row.names = TRUE)
...
env.cor5 <- read.csv(file = file.path(here(), "data", "env_cor_chelsa_downsampled_abs.csv"))
