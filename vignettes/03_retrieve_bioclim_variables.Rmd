...
Finally, I will convert the rasters to the `.ascii` format required by MaxEnt. I will also convert all `NAs` to `-9999`, as required by MaxEnt.
...
Now, we will need to go through all of the above steps in section 2.3 for the CMIP6 versions of the rasters. 
...
I will downsize the rasters from the `v1` folder to perform a co-linearity analysis between the layers. This will only be done for the historical variables.
