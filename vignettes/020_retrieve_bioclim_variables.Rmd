...
```
```{r one last check for consistency}
# resolutions
res(ref_chelsa_bio1_main)
res(ref_wc_bio1_mask)
# they are identical
...
```{r create subdirectories- ssp370, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r get file names 5, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r isolate only final variables 5, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r loop to tidy rasters- ssp370, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r get file names 6, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r isolate only final variables 6, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r on-demand aggregation of rasters and coversion to AAIgrid- ssp370, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r create subdirectories- ssp585, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r get file names 7, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r isolate only final variables 7, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r loop to tidy rasters- ssp 585, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r get file names 8, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r isolate only final variables 8, eval = FALSE, warning = FALSE, message = FALSE}
...
```{r on-demand aggregation of rasters and convert to AAIgrid- ssp585, eval = FALSE, warning = FALSE, message = FALSE}
