...
The code for this vignette was originally taken from "slfrsk_maxent_modeling.Rmd", which is stored in `slfSpread/sandbox/vignettes-old`.
...
This additional step can be run on-demand. I will aggregate selected rasters to a lower resolution, with roughly 10km grid cells. This step is also performed in the "loop to tidy rasters" chunck, but I will perform it for selected rasters here.
