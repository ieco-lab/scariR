---
title: "Analyze biological realism of model response curves"
...
```{r scatter style object- marginal, eval = TRUE}
...
```{r load model objects- regional ensemble, eval = TRUE}
...
# create marginal response plots {.hidden}

## Bio 11

```{r extract marginal plots per model- bio 11, eval = TRUE}
...
```{r maximum activity- bio 11 marginal, eval = TRUE}
...
```{r combine plots- bio 11 marginal, eval = TRUE}
...
```{r extract marginal plots per model- bio 12, eval = TRUE}
...
```{r maximum activity- bio 12 marginal, eval = TRUE}
...
```{r combine plots- bio 12 marginal, eval = TRUE}
...
```{r extract marginal plots per model- bio 15, eval = TRUE}
...
```{r maximum activity- bio 15 marginal, eval = TRUE}
...
```{r combine plots- bio 15 marginal, eval = TRUE}
...
```{r extract marginal plots per model- bio 2, eval = TRUE}
...
```{r maximum activity- bio 2 marginal, eval = TRUE}
...
```{r combine plots- bio 2 marginal, eval = TRUE}
...
```{r scatter style object- univar, eval = TRUE}
...
```{r extract univar plots per model- bio 11 univar, eval = TRUE}
...
```{r maximum activity- bio 11 univar, eval = TRUE}
...
```{r combine plots- bio 11 univar, eval = TRUE}
...
```{r save plot- bio 11 univar, eval = TRUE}
...
```{r extract univar plots per model- bio 12, eval = TRUE}
...
```{r maximum activity- bio 12 univar, eval = TRUE}
...
```{r combine plots- bio 12 univar, eval = TRUE}
...
```{r extract univar plots per model- bio 15, eval = TRUE}
...
```{r maximum activity- bio 15 univar, eval = TRUE}
...
```{r combine plots- bio 15 univar, eval = TRUE}
...
```{r extract univar plots per model- bio 2, eval = TRUE}
...
```{r maximum activity- bio 2 univar, eval = TRUE}
...
```{r combine plots- bio 2 univar, eval = TRUE}
...
```{r univar plot style object, eval = TRUE}
...
```{r load model objects- global, eval = TRUE}

global_model <- read_rds(file = file.path(mypath, "slf_global_v3", "global_model.rds"))

```

## Create marginal plots {.hidden}

```{r marginal plot style object, eval = TRUE}
...
```{r extract marginal plots for global model, eval = TRUE}
...
```{r maximum activity- global marginal, eval = TRUE}
...
```{r bio11 plot- global marginal, eval = TRUE}
...
```{r bio12 plot- global marginal, eval = TRUE}
...
```{r bio15 plot- global marginal, eval = TRUE}
...
```{r bio2 plot- global marginal, eval = TRUE}
...
```{r extract univariate plots for global model, eval = TRUE}
...
```{r maximum activity- global univar, eval = TRUE}
...
```{r bio11 plot- global univar, eval = TRUE}
...
```{r bio12 plot- global univar, eval = TRUE}
...
```{r bio15 plot- global univar, eval = TRUE}
...
```{r bio2 plot- global univar, eval = TRUE}
...
## marginal response {.hidden}

```{r scatter style object- marginal combined, eval = TRUE}
...
```{r combine plots- bio11, eval = TRUE}
...
```{r combine plots- bio12, eval = TRUE}
...
```{r combine plots- bio15 combined, eval = TRUE}
...
```{r combine plots- bio2, eval = TRUE}
...
```{r scatter style object- univar combined, eval = TRUE}
...
```{r combine plots- bio 11 univar combined, eval = TRUE}
...
```{r combine plots- bio 12 univar combined, eval = TRUE}
...
```{r combine plots- bio 15 univar combined, eval = TRUE}
...
```{r combine plots- bio 2 univar combined, eval = TRUE}
...
# Patchwork together plots {.hidden}
