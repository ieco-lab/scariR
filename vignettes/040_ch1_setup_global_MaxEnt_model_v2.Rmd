...
In this vignette, I will set up to run the global model and project it for climate change. In the next vignette I will run this model, and in the following vignette I will set up for the invaded regional model.
...
# save as rda file
save(global_points, file = file.path(here(), "data", "global_background_points_v2.rda"))
