...
I will choose the presence points I will use to train and validate each regional-scale model. 
...
I will train each regional-scale on all of its regional slf presences and test based on another region's points. Here are the models and their training / validation (test) regions
...
regional_invaded_patchwork <- (
  ...
  (regional_invaded_withSLF_plot + regional_native_slf_plot) 
  ) +
  plot_annotation(
    title = "'Ri.NAmerica' model elements",
    subtitle = "A) training region B) background points C) background selection area D) test region"
    ) 
...
regional_invaded_asian_patchwork <- (
  ...
  (regional_invaded_asian_withSLF_plot + regional_invaded_slf_plot) 
  ) +
  plot_annotation(
...
regional_native_patchwork <- (
  ...
  (regional_native_withSLF_plot | regional_invaded_slf_plot)
   ) +
  plot_annotation(
