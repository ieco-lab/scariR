...
First, I will use the [kgc](https://cran.r-project.org/web/packages/kgc/index.html) package to retrieve a global raster of the Köppen-Geiger climate zones.
...
Now I will download the Köppen-Geiger climate zones, which I will use to clip the bioclim layers.
...
# create plotting copy that is reprojected
koeppen_zones_rast_plot_layer <- terra::project(x = koeppen_zones_rast, y = "ESRI:54017", method = "bilinear", threads = TRUE)
# convert to df
koeppen_zones_rast_plot_layer <- terra::as.data.frame(koeppen_zones_rast_plot_layer, xy = TRUE)


# plot main layer as example
KG_climate_map <- ggplot() +
  # change scale of plots to be standard across figures
  geom_raster(data = koeppen_zones_rast_plot_layer, 
            aes(x = x, y = y, fill = as.factor(koeppen_climate_zones))) +
    labs(
      title = "Köppen-Geiger Climate Zones", 
      x = "longitude",
      y = "latitude",
      fill = "K-G climate zone"
    ) +
  scale_x_continuous(labels = scales::comma, expand = c(0, 0)) +
  scale_y_continuous(labels = scales::comma, expand = c(0, 0)) +
...
# create plot layer and reproject
regional_invaded_withSLF_plot_layer <- sf::st_transform(x = regional_invaded_withSLF, crs = "ESRI:54017")

# get extent
st_bbox(regional_invaded_withSLF_plot_layer) 
...
(regional_invaded_withSLF_plot <- ggplot() +
   ...
   geom_sf(data = regional_invaded_withSLF_plot_layer, aes(fill = as.factor(koeppen_climate_zones)), color = "black") +
   # scales
   labs(
     title = "Köppen-Geiger climate zones as background selection area\nfor 'Ri.NAmerica' model",
     caption = "K-G zones selected if containing SLF presences",
     x = "longitude",
     y = "latitude",
     fill = "Köppen climate zone"
     ) +
   scale_fill_brewer(palette = "Paired", labels = kmz_names_factor) +
   theme_classic() +
   theme(legend.position = "right") +
   coord_sf(datum = sf::st_crs("ESRI:54017"), xlim = c(-13379444, -5073584), ylim = c(2395972, 6404431))
)
...
# reproject raster
bio11 <- terra::project(bio11, y = "ESRI:54017", method = "bilinear", threads = TRUE)
# convert to df
...
# create plot layer and reproject
regional_invaded_asian_withSLF_plot_layer <- sf::st_transform(x = regional_invaded_asian_withSLF, crs = "ESRI:54017")

# get extent
st_bbox(regional_invaded_asian_withSLF_plot_layer) 
...
(regional_invaded_asian_withSLF_plot <- ggplot() +
   ...
   # slf native range shapefile
   geom_sf(data = regional_invaded_asian_withSLF_plot_layer, aes(fill = as.factor(koeppen_climate_zones)), color = "black") +
   # scales
   labs(
     title = "Köppen-Geiger climate zones as background selection area\nfor 'Ri.Asia' model",
     caption = "K-G zones selected if containing SLF presences",
...
# reproject raster
bio11_invaded_asian_plot_layer <- terra::project(bio11_invaded_asian, y = "ESRI:54017", method = "bilinear", threads = TRUE)
# convert to df
bio11_invaded_asian_plot_layer <- terra::as.data.frame(bio11_invaded_asian_plot_layer, xy = TRUE)

# plot main layer as example
(ggplot() +
  # change scale of plots to be standard across figures
  geom_raster(data = bio11_invaded_asian_plot_layer, 
            aes(x = x, y = y, fill = `CHELSA_bio11_1981-2010_V.2.1`)) +
  xlab("longitude") +
  ylab("latitude") +
  theme_minimal() +
...
# create plot layer and reproject
regional_native_withSLF_plot_layer <- sf::st_transform(x = regional_native_withSLF, crs = "ESRI:54017")

# get extent
st_bbox(regional_native_withSLF_plot_layer) 
...
(regional_native_withSLF_plot <- ggplot() +
  geom_polygon(
   ...
   # slf native range shapefile
   geom_sf(data = regional_native_withSLF_plot_layer, aes(fill = as.factor(koeppen_climate_zones)), color = "black") +
   # scales
   labs(
     title = "Köppen climate zones as background selection area for 'Rn' model",
     caption = "K-G zones selected if containing SLF presences",
     x = "longitude",
     y = "latitude",
     fill = "Köppen climate zone"
...
# reproject raster
bio11_native_plot_layer <- terra::project(bio11_native, y = "ESRI:54017", method = "bilinear", threads = TRUE)
# convert to df
bio11_native_plot_layer <- terra::as.data.frame(bio11_native_plot_layer, xy = TRUE)

# plot main layer as example
(ggplot() +
  # change scale of plots to be standard across figures
  geom_raster(data = bio11_native_plot_layer, 
            aes(x = x, y = y, fill = `CHELSA_bio11_1981-2010_V.2.1`)) +
  xlab("longitude") +
  ylab("latitude") +
  theme_minimal() +
...
(regional_invaded_background_plot <- ggplot() +
   ...
   labs(
     title = "'Ri.NAmerica' model background points", 
     x = "longitude",
     y = "latitude"
     ) +
   theme_classic() +
...
```{r load in data for plotting, eval = TRUE}
...
ggsave(regional_invaded_asian_points_plot, 
       filename = file.path(
         here::here(), "vignette-outputs", "figures", "regional_invaded_asian_model_background_points_v2.jpg"
         ),
       height = 8, 
       width = 10,
       device = jpeg,
...
# background raster for plotting
...
regional_invaded_slf_plot <- ggplot() +
  ...
  labs(
    title = "'Ri.NAmerica' model SLF presences",
    x = "longitude",
    y = "latitude"
  ) +
  scale_x_continuous(expand = c(0, 0)) +
...
regional_invaded_asian_slf_plot <- ggplot() +
  ...
  labs(
    title = "'Ri.Asia' model SLF presences",
    x = "longitude",
    y = "latitude"
  ) +
  scale_x_continuous(expand = c(0, 0)) +
...
regional_invaded_test_plot <- ggplot() +
  ...
  labs(
    title = "'Ri.NAmerica' model validation (test) presences",
    x = "longitude",
    y = "latitude"
  ) +
  scale_x_continuous(expand = c(0, 0)) +
...
regional_invaded_asian_test_plot <- ggplot() +
  ...
  labs(
    title = "'Ri.Asia' model test presences",
    x = "longitude",
    y = "latitude"
  ) +
  scale_x_continuous(expand = c(0, 0)) +
