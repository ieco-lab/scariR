...
I will use the following list of hyperparameters to train the initial model, but these parameters may change based on model tuning, which I will perform next.
...
write.csv(regional_invaded_model_tuned@results, file = file.path(mypath, "regional_invaded_model_tuning_results.csv"))

# save model tuning object
write_rds(regional_invaded_model_tuned, file = file.path(mypath, "regional_invaded_models_tuned.rds"))
