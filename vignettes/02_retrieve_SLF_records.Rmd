...
write_csv(slf_gbif_coords3, file = file.path(here(), "data", "slf_gbif_cleaned_coords_v2.csv"))
...
write_csv(slf_lyde3, file = file.path(here(), "data", "slf_lyde_cleaned_coords_v1.csv"))
...
# thinned data
gbif_thinned <- read_csv(file = file.path(here(), "data", "slf_gbif_cleaned_coords_v2.csv"))
...
slf_published_papers <- read_csv(file.path(here(), "data", "slf_publishedOccurrenceRecords_papers.csv"))
...
slf_published <- read_csv(file.path(here(), "data", "slf_publishedOccurrenceRecords_v1.csv"))
...
slf_gbif_coords3 <- read_csv(file.path(here(), "data", "slf_gbif_cleaned_coords_v2.csv"))

slf_lyde3 <- read_csv(file.path(here(), "data", "slf_lyde_cleaned_coords_v1.csv"))
...
# save
write_csv(x = slf_all_coords3, file = file.path(here(), "data", paste0("slf_all_final_coords_v0_", format(Sys.Date(), "%Y-%m"), ".csv")))
...
if(FALSE) {
  ...
  slf_coords4 <- read_csv(file = file.path(here(), "data", "slf_gbif_cleaned_v2.csv"))
  ...
  write_csv(slf_coords4, file = file.path(here(), "data", "slf_gbif_cleaned_v3.csv"))
...
if(FALSE) {
  ...
  # new data
  slf_new <- read_csv(file = file.path(here(), "data", "slf_gbif_cleaned_v2.csv"))
...
1. The code for this section was pulled directly from the [slfrsk research compendium](https://ieco-lab.github.io/slfrsk/articles/vignette-003-get-gbif-data.html), with modifications.
