...
slf_suit_regional_invaded_hist <- read_csv(
  file = file.path(mypath, "slf_regional_invaded_v6", "regional_invaded_slf_all_coords_1981-2010_xy_pred_suit_clamped_cloglog.csv")
  ) %>%
  dplyr::rename("slf_suit_regional_invaded_hist" = "cloglog_suitability") 

# regional_native
slf_suit_regional_native_hist <- read_csv(
  file = file.path(mypath, "slf_regional_native_v2", "regional_native_slf_all_coords_1981-2010_xy_pred_suit_clamped_cloglog.csv")
  ) %>%
...
# global
slf_suit_global_hist_rescaled <- slfSpread::rescale_cloglog_suitability_v0(
...
# regional_invaded
slf_suit_regional_invaded_hist_rescaled <- slfSpread::rescale_cloglog_suitability_v0(
...
# regional_native
slf_suit_regional_native_hist_rescaled <- slfSpread::rescale_cloglog_suitability_v0(
...
# rescaled output
slf_invaded_global_joined_rescaled <- full_join(slf_suit_regional_invaded_hist_rescaled, slf_suit_global_hist_rescaled, by = c("Species", "x", "y")) %>%
  dplyr::select(-Species)
...
slf_native_global_joined <- full_join(slf_suit_regional_native_hist, slf_suit_global_hist, by = c("Species", "x", "y")) %>%
  dplyr::select(-Species)
# rescaled output
slf_native_global_joined_rescaled <- full_join(slf_suit_regional_native_hist_rescaled, slf_suit_global_hist_rescaled, by = c("Species", "x", "y")) %>%
  dplyr::select(-Species)
...
# global
slf_suit_global_GFDL_ssp370_rescaled <- slfSpread::rescale_cloglog_suitability(
  xy.predicted = slf_suit_global_GFDL_ssp370,
  thresh = "MTSS",
  summary.file = summary_global,
  rescale.name = "slf_suit_global_GFDL_ssp370",
  rescale.thresholds = TRUE
)
# extract rescaled values and thresholds
slf_suit_global_GFDL_ssp370_rescaled_thresholds <- slf_suit_global_GFDL_ssp370_rescaled[[2]]
slf_suit_global_GFDL_ssp370_rescaled <- slf_suit_global_GFDL_ssp370_rescaled[[1]]



# regional_invaded
slf_suit_regional_invaded_GFDL_ssp370_rescaled <- slfSpread::rescale_cloglog_suitability(
  xy.predicted = slf_suit_regional_invaded_GFDL_ssp370,
  thresh = "MTSS",
  summary.file = summary_regional_invaded,
  rescale.name = "slf_suit_regional_invaded_GFDL_ssp370",
  rescale.thresholds = TRUE
)
# extract rescaled values and thresholds
slf_suit_regional_invaded_GFDL_ssp370_rescaled_thresholds <- slf_suit_regional_invaded_GFDL_ssp370_rescaled[[2]]
slf_suit_regional_invaded_GFDL_ssp370_rescaled <- slf_suit_regional_invaded_GFDL_ssp370_rescaled[[1]]




# regional_native
slf_suit_regional_native_GFDL_ssp370_rescaled <- slfSpread::rescale_cloglog_suitability(
  xy.predicted = slf_suit_regional_native_GFDL_ssp370,
  thresh = "MTSS",
  summary.file = summary_regional_native,
  rescale.name = "slf_suit_regional_native_GFDL_ssp370",
  rescale.thresholds = TRUE
)
# extract rescaled values and thresholds
slf_suit_regional_native_GFDL_ssp370_rescaled_thresholds <- slf_suit_regional_native_GFDL_ssp370_rescaled[[2]]
slf_suit_regional_native_GFDL_ssp370_rescaled <- slf_suit_regional_native_GFDL_ssp370_rescaled[[1]]
...
# join datasets for plotting
# default output
slf_invaded_global_joined_GFDL_ssp370 <- full_join(slf_suit_regional_invaded_GFDL_ssp370, slf_suit_global_GFDL_ssp370, by = c("Species", "x", "y")) %>%
  dplyr::select(-Species)
# rescaled output
slf_invaded_global_joined_GFDL_ssp370_rescaled <- full_join(slf_suit_regional_invaded_GFDL_ssp370_rescaled, slf_suit_global_GFDL_ssp370_rescaled, by = c("Species", "x", "y")) %>%
  dplyr::select(-Species)
...
slf_native_global_joined_GFDL_ssp370 <- full_join(slf_suit_regional_native_GFDL_ssp370, slf_suit_global_GFDL_ssp370, by = c("Species", "x", "y")) %>%
  dplyr::select(-Species)
# rescaled output
slf_native_global_joined_GFDL_ssp370_rescaled <- full_join(slf_suit_regional_native_GFDL_ssp370_rescaled, slf_suit_global_GFDL_ssp370_rescaled, by = c("Species", "x", "y")) %>%
  dplyr::select(-Species)
...
(slf_invaded_global_01scale_change_plot <- ggplot(data = slf_invaded_global_joined_change) +
   ...
   # axes scaling
   scale_x_continuous(name = "'global' model suitability", limits = c(0, 1), breaks = breaks) + 
   scale_y_continuous(name = "'regional_invaded' model suitability", limits = c(0, 1), breaks = breaks) +
   # scales style
...
# join datasets for plotting
slf_invaded_global_joined_rescale_change <- full_join(slf_invaded_global_joined_rescaled, slf_invaded_global_joined_GFDL_ssp370_rescaled, by = c("x", "y")) 
...
# plot
(slf_invaded_global_MTSS_rescaled_change_plot <- ggplot(data = slf_invaded_global_joined_rescale_change) +
   # threshold lines
   # MTP threshold
   geom_vline(xintercept = as.numeric(slf_suit_global_hist_rescaled_thresholds[1, 2]), linetype = "dotted", alpha = 0.5) +
   geom_hline(yintercept = as.numeric(slf_suit_regional_invaded_hist_rescaled_thresholds[1, 2]), linetype = "dotted", alpha = 0.5) +
   # MTSS threshold
   geom_vline(xintercept = as.numeric(slf_suit_global_hist_rescaled_thresholds[5, 2]), linetype = "dashed") +
   geom_hline(yintercept = as.numeric(slf_suit_regional_invaded_hist_rescaled_thresholds[5, 2]), linetype = "dashed") +
   # arrows indicating change
   geom_segment(
     aes(
       x = slf_suit_global_hist_rescaled,
       xend = slf_suit_global_GFDL_ssp370_rescaled,
       y = slf_suit_regional_invaded_hist_rescaled,
       yend = slf_suit_regional_invaded_GFDL_ssp370_rescaled
     ), 
     arrow = arrow(angle = 8, type = "closed"), linewidth = 0.25, color = "azure4", alpha = 0.7
   ) +
   # historical data
   geom_point(
     aes(x = slf_suit_global_hist_rescaled, y = slf_suit_regional_invaded_hist_rescaled, color = "1981-2010"), 
     size = 1
     ) +
   # GFDL ssp370 data
   geom_point(
     aes(x = slf_suit_global_GFDL_ssp370_rescaled, y = slf_suit_regional_invaded_GFDL_ssp370_rescaled, color = "2041-2070\nGFDL ssp370"), 
     size = 1
     ) +
   # axes scaling
   ...
   # scales style
   labs(title = "Risk of known SLF populations persisting under climate change",
...
ggsave(
  slf_invaded_global_MTSS_rescaled_change_plot, 
  filename = file.path(
    here(), "vignette-outputs", "figures", "xy_suitability_slf_CC_shift_global_invaded_regional_rescaled.jpg"
    ),
  height = 8, 
  width = 10,
  device = "jpeg",
...
# join datasets for plotting
slf_native_global_joined_rescale_change <- full_join(slf_native_global_joined_rescaled, slf_native_global_joined_GFDL_ssp370_rescaled, by = c("x", "y")) 
...
# plot
(slf_native_global_MTSS_rescaled_change_plot <- ggplot(data = slf_native_global_joined_rescale_change) +
   # threshold lines
   # MTP threshold
   geom_vline(xintercept = as.numeric(slf_suit_global_hist_rescaled_thresholds[1, 2]), linetype = "dotted", alpha = 0.5) +
   ...
   # MTSS threshold
   geom_vline(xintercept = as.numeric(slf_suit_global_hist_rescaled_thresholds[5, 2]), linetype = "dashed") +
   geom_hline(yintercept = as.numeric(slf_suit_regional_native_hist_rescaled_thresholds[5, 2]), linetype = "dashed") +
   # arrows indicating change
   geom_segment(
     aes(
       x = slf_suit_global_hist_rescaled,
       xend = slf_suit_global_GFDL_ssp370_rescaled,
       y = slf_suit_regional_native_hist_rescaled,
       yend = slf_suit_regional_native_GFDL_ssp370_rescaled
     ), 
     arrow = arrow(angle = 8, type = "closed"), linewidth = 0.25, color = "azure4", alpha = 0.7
   ) +
   # historical data
   geom_point(
     aes(x = slf_suit_global_hist_rescaled, y = slf_suit_regional_native_hist_rescaled, color = "1981-2010"), 
     size = 1
     ) +
   # GFDL ssp370 data
   geom_point(
     aes(x = slf_suit_global_GFDL_ssp370_rescaled, y = slf_suit_regional_native_GFDL_ssp370_rescaled, color = "2041-2070\nGFDL ssp370"), 
     size = 1
     ) +
   # axes scaling
   scale_x_continuous(name = "risk according to 'global' model", limits = c(0, 1), breaks = breaks) + 
...
ggsave(
  slf_native_global_MTSS_rescaled_change_plot, 
  filename = file.path(
    here(), "vignette-outputs", "figures", "xy_suitability_slf_CC_shift_global_native_regional_rescaled.jpg"
    ),
  height = 8, 
  width = 10,
  device = "jpeg",
