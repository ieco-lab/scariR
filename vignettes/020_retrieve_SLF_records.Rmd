...
# rename .zip file
file.rename(
  from = file.path(here(), "data-raw", "0046146-231120084113126.zip"),
  to = file.path(here(), "data-raw", paste0("slf_gbif_raw_query_", format(Sys.Date(), "%Y-%m-%d"), ".zip"))
  )
...
write_csv(x = slf_gbif_download_simple, 
          file = file.path(here(), "data-raw", paste0("slf_gbif_raw_coords_", format(Sys.Date(), "%Y-%m-%d"), ".csv"))
)
...
# read in data
slf_gbif_coords1 <- read_csv(file = file.path(here(), "data-raw", "slf_gbif_raw_coords_2024-01-05.csv"))
...
write_csv(slf_gbif_coords3, file = file.path(here(), "vignette-outputs", "data-tables", "slf_gbif_cleaned_coords_2024-01-05.csv"))

# also save as a .rds file
write_rds(slf_gbif_coords3, file = file.path(here(), "data", "slf_gbif_cleaned_coords_2024-01-05.rds"))
...
if (FALSE) {
  ...
  slf_lyde_raw <- read_csv(file = file.path(here(), "data-raw", "slf_lyde_raw_coords_2023-12-12.csv"))
  ...
  write_csv(x = slf_lyde_raw, file = file.path(here(), "data-raw", "slf_lyde_raw_coords_2023-12-12.csv"))
...
# read in data
slf_lyde <- read_csv(file = file.path(here(), "data-raw", "slf_lyde_raw_coords_2023-12-12.csv"))
...
write_csv(slf_lyde3, file = file.path(here(), "vignette-outputs", "data-tables", "slf_lyde_cleaned_coords_2023-12-12.csv"))

# also save as a .rds file
write_rds(slf_lyde3, file = file.path(here(), "data", "slf_lyde_cleaned_coords_2023-12-12.rds"))
...
# raw data
gbif_raw <- read_csv(file = file.path(here(), "data-raw", "slf_gbif_raw_coords_2024-01-05.csv"))

# thinned data
gbif_thinned <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "slf_gbif_cleaned_coords_2024-01-05.csv"))
...
# raw data
lyde_raw <- read_csv(file = file.path(here(), "data-raw", "slf_lyde_raw_coords_2023-12-12.csv"))

# thinned data
lyde_thinned <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "slf_lyde_cleaned_coords_2023-12-12.csv"))
...
slf_published <- read_csv(file.path(here(), "data-raw", "slf_publishedOccurrenceRecords_v2.csv"))

# save as .rds before proceeding
write_rds(x = slf_published, file = file.path(here(), "data", "slf_publishedOccurrenceRecords_v2.rds"))
...
slf_gbif_coords3 <- read_csv(file.path(here(), "vignette-outputs", "data-tables", "slf_gbif_cleaned_coords_2024-01-05.csv"))

slf_lyde3 <- read_csv(file.path(here(), "vignette-outputs", "data-tables", "slf_lyde_cleaned_coords_2023-12-12.csv"))
...
write_csv(x = slf_all_coords, file = file.path(here(), "vignette-outputs", "data-tables", "slf_all_coords_2024-02-01.csv"))
...
slf_all_coords <- read_csv(file.path(here(), "vignette-outputs", "data-tables", "slf_all_coords_2024-02-01.csv"))
...
if(TRUE) {
  ...
  slf_all_coords2 <- spThin::thin(loc.data = slf_all_coords, 
                              ...
                              write.log.file = TRUE, 
                              log.file = file.path(here(), "vignette-outputs", "data-tables", paste0("slf_all_coords_cleaned_thinning_log_2024-02-01.txt")),
...
slf_all_coords2 <- read_csv(file.path(here(), "vignette-outputs", "data-tables", "slf_all_coords_cleaned_2024-02-01_thin1.csv"))
...
# save
write_csv(x = slf_all_coords3, file = file.path(here(), "vignette-outputs", "data-tables", paste0("slf_all_final_coords_2024-02-01.csv")))

# also save as a .rds file
write_rds(slf_all_coords3, file = file.path(here(), "data", paste0("slf_all_final_coords_2024-02-01.rds")))

```

```{r map all points}

slf_all_coords3 <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "slf_all_final_coords_2024-02-01.csv"))
...
# save output
ggsave(SLF_by_longitude, filename = file.path(here(), "vignette-outputs", "figures", "SLF_final_all_coords_by_longitude.jpg"),
       height = 8, 
       width = 10,
       device = "jpeg",
       dpi = "retina")
...
if(FALSE) {
  ...
  slf_coords4 <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "slf_gbif_cleaned_2024-01-05.csv"))
  ...
  write_csv(slf_coords4, file = file.path(here(), "vignette-outputs", "data-tables", "slf_gbif_cleaned_2024-01-05_v1.csv"))
  
  # also save as a .rds file
  write_rds(slf_coords4, file = file.path(here(), "data", "slf_gbif_cleaned_2024-01-05_v1.rds"))
...
if(FALSE) {
  ...
  # new data
  slf_new <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "slf_gbif_cleaned_2024-01-05.csv"))
