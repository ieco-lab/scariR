...
**Note:** I have added a number of `if()` statements throughout my vignettes, usually at key save points. Simply change the `FALSE` within the `if()` statement to `TRUE` to run a chunk. This is to prevent accidental overwriting of files.
