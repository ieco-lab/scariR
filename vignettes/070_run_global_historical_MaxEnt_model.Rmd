...
a_global_background_points <- read.csv(file.path(here(), "vignette-outputs", "data-tables", "global_background_points.csv"))
...
SDMtune::swd2csv(swd = global_historical_SWD, file_name = c(
  file.path(here(), "vignette-outputs", "data-tables", "global_historical_slf_presences_with_data.csv"),
  file.path(here(), "vignette-outputs", "data-tables", "global_historical_absences_with_data.csv")
  ))
...
* replicates = 10- all final models will have 10 replicates
...
mypath <- file.path(here() %>% 
                       dirname(),
                     "maxent/models/slf_global_historical_step2")
