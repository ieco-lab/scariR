---
title: "Compare historical global and invaded regional models (chapter 1)"
...
# global raster
global_hist_mean <- terra::rast(x = file.path(mypath, "slf_global_ch1", "global_predicted_suitability_NAmerica_1981-2010_projected_mean.asc"))
# convert to df for plotting
global_hist_mean_df <- terra::as.data.frame(x = global_hist_mean, xy = TRUE)

# regional raster
invaded_regional_hist_mean <- terra::rast(x = file.path(mypath, "slf_invaded_regional_ch1", "invaded_regional_predicted_suitability_NAmerica_1981-2010_projected_mean.asc"))
# convert to df for plotting
invaded_regional_hist_mean_df <- terra::as.data.frame(x = invaded_regional_hist_mean, xy = TRUE)
...
# suitability values
# regional
slf_suit_regional <- read_csv(
  file = file.path(mypath, "slf_invaded_regional_ch1", "invaded_regional_slf_all_coords_1981-2010_xy_predicted_suitability_mean.csv")
  ) %>%
  dplyr::rename("invaded_regional_suitability" = "cloglog_suitability")
# global
slf_suit_global <- read_csv(
  file = file.path(mypath, "slf_global_ch1", "global_slf_all_coords_1981-2010_predicted_suitability_mean.csv")
  ) %>%
...
# regional
summary_regional <- read_csv(file = file.path(mypath, "slf_invaded_regional_ch1", "invaded_regional_summary_all_iterations.csv"))
# global
summary_global <- read_csv(file = file.path(mypath, "slf_global_ch1", "global_summary_all_iterations.csv"))
