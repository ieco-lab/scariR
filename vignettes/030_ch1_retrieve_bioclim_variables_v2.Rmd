...
env.cor2 <- read.csv(file = file.path(here(), "vignette-outputs", "data-tables", "env_cor_chelsa_downsampled.csv")) 
...
# write tidied data
write.csv(x = env.cor4, file = file.path(here(), "vignette-outputs", "data-tables", "env_cor_chelsa_downsampled_abs.csv"), col.names = TRUE, row.names = TRUE)
...
env.cor5 <- read.csv(file = file.path(here(), "vignette-outputs", "data-tables", "env_cor_chelsa_downsampled_abs.csv"))
...
ggsave(env.cor_plot, filename = file.path(here(), "vignette-outputs", "figures", "env_cor_CHELSA.jpg"),
       height = 8, 
       width = 10,
       device = "jpeg",
       dpi = "retina")
...
ggsave(env.cor_binary_plot, filename = file.path(here(), "vignette-outputs", "figures", "env_cor_CHELSA_binary.jpg"),
       height = 8, 
       width = 10,
       device = "jpeg",
       dpi = "retina")
