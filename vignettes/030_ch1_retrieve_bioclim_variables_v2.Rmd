...
This additional step can be run on-demand. I will aggregate selected rasters to a lower resolution, with roughly 10km grid cells. We want to aggregate at 10km because we will be downsampling tthe resolution of our analysis to account for survey bias.
...
if (FALSE) {
  ...
  for(a in seq_along(env.files)){
    ...
    rast.hold <- terra::aggregate(x = rast.hold, fact = 10, fun = "mean")
