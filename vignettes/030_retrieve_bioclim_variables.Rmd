...
We will be projecting all rasters to the Behrmann cylindrical equal-area projection, which is EPSG:53017.
...
# new projection
main_layer <- terra::project(x = main_layer, y = "EPSG:53017", method = "bilinear")
mask_layer <- terra::project(x = mask_layer, y = "EPSG:53017", method = "bilinear")
...
# view list of filetypes for terra, use .ascii
  ...
  for(a in seq_along(env.files)) {
    ...
    # set crs
    rast.hold <- terra::project(x = rast.hold, y = "EPSG:53017", method = "bilinear")
