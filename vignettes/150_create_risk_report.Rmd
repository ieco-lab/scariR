...
```{r get country iso codes, eval = TRUE}
...
```{r patchwork plots- western europe}
...
```{r patchwork plots- eastern europe}
...
```{r patchwork plots- north america}
