...
Primarily, I would like to use the wineries dataset to create a report for each unique country on the list. Our winery records contain 64 unique countries that I will create reports for.
...
Alternatively, I will create individualized reports and maps for key viticultural areas of interest. I will group these regions by expeted gain or loss in viticultural risk, and by geography.
