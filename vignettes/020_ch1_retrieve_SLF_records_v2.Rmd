...
I will begin by retrieving the GBIF taxonimic ID for Lycorma delicatula.
...
save(slf_gbif_coords3, file = file.path(here(), "data", "slf_gbif_cleaned_coords_2024-01-05.rda"))
...
# also save as a .rda file
save(slf_lyde3, file = file.path(here(), "data", "slf_lyde_cleaned_coords_2023-12-12.rda"))
...
write_csv(x = slf_all_coords, file = file.path(here(), "vignette-outputs", "data-tables", "slf_all_coords_2024-01-05.csv"))
...
slf_all_coords <- read_csv(file.path(here(), "vignette-outputs", "data-tables", "slf_all_coords_2024-01-05.csv"))
...
if(FALSE) {
  ...
  slf_all_coords2 <- spThin::thin(loc.data = slf_all_coords, 
                              ...
                              write.log.file = TRUE, 
                              log.file = file.path(here(), "vignette-outputs", "data-tables", paste0("slf_all_coords_cleaned_thinning_log_2024-01-05.txt")),
                              ...
                              out.base = paste0("slf_all_coords_cleaned_2024-01-05"),
...
slf_all_coords2 <- read_csv(file.path(here(), "vignette-outputs", "data-tables", "slf_all_coords_cleaned_2024-01-05_thin1.csv"))
...
# save
write_csv(x = slf_all_coords3, file = file.path(here(), "vignette-outputs", "data-tables", paste0("slf_all_final_coords_2024-01-05.csv")))

# also save as a .rda file
save(slf_all_coords3, file = file.path(here(), "data", paste0("slf_all_final_coords_2024-01-05.rda")))

```

```{r map all points}

slf_all_coords3 <- read_csv(file = file.path(here(), "vignette-outputs", "data-tables", "slf_all_final_coords_2024-01-05.csv"))
...
if(FALSE) {
  ...
  # also save as a .rda file
  save(slf_coords4, file = file.path(here(), "data", "slf_gbif_cleaned_2024-01-05_v1.rda"))
