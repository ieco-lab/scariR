---
title: "Run 'regional_native' maxent model based on east Asian range"
...
In the last vignette, I trained the first regional model, based on the invaded range. This vignette will train the regional_native model based on SLF presences found in the native range. This model has the advantage that SLF is likely stable within its niche in China.
...
The model will be tested using all presences from the USA.
...
mypath <- file.path(here() %>% 
                       dirname(),
                     "maxent/models/slf_regional_native_v1")
