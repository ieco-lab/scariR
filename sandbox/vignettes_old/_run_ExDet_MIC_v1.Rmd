...
I need to import the rasters of the background point area so that I can display that on the ExDet and MIC plots
...
exdet_global_hist_plot <- ggplot() +
  ...
  breaks = c(
    round(min(values(exdet_global_hist), na.rm = TRUE), 5), 
    round(0, 1), round(1, 1), 
    round(max(values(exdet_global_hist), na.rm = TRUE), 5)
    ),
  guide = guide_colorbar(frame.colour = "black", ticks.colour = "black", barwidth = 20)
  )
...
exdet_global_CMIP6_plot <- ggplot() +
  ...
  breaks = c(
    round(min(values(exdet_global_CMIP6), na.rm = TRUE), 6), 
    round(0, 1), round(1, 1), 
    round(max(values(exdet_global_CMIP6), na.rm = TRUE), 6)
    ),
  guide = guide_colorbar(frame.colour = "black", ticks.colour = "black", barwidth = 20)
  )
