...
File paths edited 2023-01-24

```{r load necesssary packages, echo = FALSE}

library(slfrsk) #this package, has extract_enm()
library(SLFspread) #package to get tinyslf dataset from
...
pdf(file.path(here::here(),"vignettes", paste0("slfrsk_spread_figure_v3.pdf")), width = (18/2.54), height = (14/2.54))
