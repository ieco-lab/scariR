---
title: "Run 'regional_invaded' model"
...
In the last vignette, I cropped the covariate layer to the extent of each regional model training area and chose background points from those layers to characterize these covariates. In this vignette, I will train our first regional model based on the invaded range.
...
# slf presences
p_slf_points <- read.csv(file = file.path(here::here(), "vignette-outputs", "data-tables", "slf_all_final_coords_2024-02-01.csv")) %>%
  dplyr::select(-species)

# entire eastern USA background point set
a_regional_invaded_background_points <- read.csv(file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_unweighted.csv"))
...
SDMtune::swd2csv(swd = regional_invaded_train, file_name = c(
  file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_train_slf_presences_with_data_v5.csv"),
  file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_background_points_with_data_v5.csv")
  ))
...
SDMtune::swd2csv(swd = regional_invaded_test, file_name = c(
  file.path(here::here(), "vignette-outputs", "data-tables", "regional_invaded_test_slf_presences_with_data_v5.csv")
  ))
...
mypath <- file.path(here::here() %>% 
                       dirname(),
                     "maxent/models/slf_regional_invaded_v5")
